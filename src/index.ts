...
const {
  PAGE_URL = 'https://haitai.notion.site/haitku',
  GA_MEASUREMENT_ID,
} = process.env;
...
const customStyle = `
  .notion-topbar > div > div:nth-last-child(1), .notion-topbar > div > div:nth-last-child(2), .notion-topbar-mobile > div > div:nth-last-child(1), .notion-topbar-mobile > div > div:nth-last-child(2),.notion-selectable-container > div > div:nth-of-type(4) > div:nth-of-type(1)
 { 
